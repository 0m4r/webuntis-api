...
Defined in: [packages/webuntis-api/src/secret.ts:6](https://github.com/0m4r/webuntis-api/blob/b034ac62bdf637888e676617f0deb1d07eac8356/packages/webuntis-api/src/secret.ts#L6)

## Extended by

- [`WebUntisQR`](WebUntisQR.md)

## Constructors

### Constructor

> **new WebUntisSecretAuth**(`school`, `user`, `secret`, `baseurl`, `identity?`, `authenticator?`, `disableUserAgent?`): `WebUntisSecretAuth`

Defined in: [packages/webuntis-api/src/secret.ts:20](https://github.com/0m4r/webuntis-api/blob/b034ac62bdf637888e676617f0deb1d07eac8356/packages/webuntis-api/src/secret.ts#L20)
